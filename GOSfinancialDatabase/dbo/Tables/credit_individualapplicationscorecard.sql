CREATE TABLE [dbo].[credit_individualapplicationscorecard] (
    ...
    CONSTRAINT [PK_credit_individualapplicationscorecard] PRIMARY KEY CLUSTERED ([ApplicationScoreCardId] ASC),
    CONSTRAINT [FK_credit_individualapplicationscorecard_credit_loanapplication] FOREIGN KEY ([LoanApplicationId]) REFERENCES [dbo].[credit_loanapplication] ([LoanApplicationId]),
    CONSTRAINT [FK_credit_individualapplicationscorecard_credit_loancustomer] FOREIGN KEY ([CustomerId]) REFERENCES [dbo].[credit_loancustomer] ([CustomerId]),
    CONSTRAINT [FK_credit_individualapplicationscorecard_credit_product] FOREIGN KEY ([ProductId]) REFERENCES [dbo].[credit_product] ([ProductId])
);
