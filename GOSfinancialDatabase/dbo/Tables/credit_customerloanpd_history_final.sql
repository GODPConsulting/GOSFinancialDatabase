CREATE TABLE [dbo].[credit_customerloanpd_history_final] (
    ...
    CONSTRAINT [PK_credit.CustomerLoanPD_history_final] PRIMARY KEY CLUSTERED ([Id] ASC)
);
