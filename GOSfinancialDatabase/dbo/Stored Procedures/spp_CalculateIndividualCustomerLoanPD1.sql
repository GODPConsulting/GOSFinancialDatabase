...
CREATE proc [dbo].[spp_CalculateIndividualCustomerLoanPD1]--1053,2076
...
--declare @CustomerName varchar(250), @LoanApplicationId varchar(250), @rnct int, @rtmax int  
...
----select CustomerId,LoanApplicationId,ProductId from credit_individualapplicationscorecard

--insert into @tab1 (ProductId)
--select distinct ProductId from credit_individualapplicationscorecard where CustomerId =1053

--declare @CustomerId int,@LoanApplicationId int,@ProductId int
--SELECT
--  @rtmax = COUNT(*)
--FROM @tab1
--set @rnct = 1
...
--select @ProductId = ProductId from @tab1 where id =@rnct
--select top 1  @LoanApplicationId = LoanApplicationId from credit_individualapplicationscorecarddetails where ProductId =@ProductId
...
--set @select=LEFT(@select,LEN(@select)-1)+' from credit_individualapplicationscorecard where ProductId = '  +''''+ 
--				cast(  @ProductId  as varchar(250))+''' '
...
--   delete from credit_customerloanpd_application where ProductId =@ProductId
--   insert into credit_customerloanpd_application(CreditRiskAttribute, AttributeField, Score, Coefficients, 
--   AverageCoefficients, CustomerId,LoanApplicationId,ProductId)
...
--b.CustomerId,b.LoanApplicationId,b.ProductId
--    from @tab3 a left outer join credit_individualapplicationscorecarddetails b on a.idx = cast(SUBSTRING(b.AttributeField,6,2) as int)
--   left outer join credit_creditriskattribute c on b.AttributeField = c.AttributeField 
--   where b.ProductId =@ProductId
--		order by  c.AttributeField
--	end
--   select @AverageCoefficients =  sum(AverageCoefficients) from  credit_customerloanpd_application where ProductId =@ProductId
...
--   --update credit_customerloanpd_application set PD = @pd where LoanApplicationId =@LoanApplicationId ;
...
update credit_individualapplicationscorecard set field1 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field1') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 3)
begin
...
update credit_individualapplicationscorecard set field2 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field2') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 4)
begin
...
update credit_individualapplicationscorecard set field3 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field3') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 5)
begin
...
update credit_individualapplicationscorecard set field4 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field4') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 6)
begin
...
update credit_individualapplicationscorecard set field5 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field5') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 7)
begin
...
update credit_individualapplicationscorecard set field6 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field6') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 8)
begin
...
update credit_individualapplicationscorecard set field7 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field7') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 9)
begin
...
update credit_individualapplicationscorecard set field8 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field8') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 10)
begin
...
update credit_individualapplicationscorecard set field9 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field9') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 11)
begin
...
update credit_individualapplicationscorecard set field10 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field10') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 12)
begin
...
update credit_individualapplicationscorecard set field11 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field11') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 13)
begin
...
update credit_individualapplicationscorecard set field12 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field12') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 14)
begin
...
update credit_individualapplicationscorecard set field13 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field13') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 15)
begin
...
update credit_individualapplicationscorecard set field14 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field14') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 16)
...
update credit_individualapplicationscorecard set field15 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field15') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 17)
begin
...
update credit_individualapplicationscorecard set field16 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field16') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 18)
begin
...
update credit_individualapplicationscorecard set field17 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field17') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 19)
begin
...
update credit_individualapplicationscorecard set field18 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field18') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 20)
begin
...
update credit_individualapplicationscorecard set field19 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field19') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 21)
begin
...
update credit_individualapplicationscorecard set field20 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field20') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 22)
begin
...
update credit_individualapplicationscorecard set field21 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field21') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 23)
...
update credit_individualapplicationscorecard set field22 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field22') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 24)
begin
...
update credit_individualapplicationscorecard set field23 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field23') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 25)
begin
...
update credit_individualapplicationscorecard set field24 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field24') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 26)
begin
...
update credit_individualapplicationscorecard set field25 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field25') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 27)
begin
...
update credit_individualapplicationscorecard set field26 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field26') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 28)
begin
...
update credit_individualapplicationscorecard set field27 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field27') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 29)
begin
...
update credit_individualapplicationscorecard set field28 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field28') where LoanApplicationId =@LoanApplicationId
end
if(@count3 = 30)
begin
...
update credit_individualapplicationscorecard set field29 = (select WeightedScore from credit_weightedriskscore where ProductId =@ProductId and CustomerTypeId =1 and FeildName = 'Field29') where LoanApplicationId =@LoanApplicationId
end
