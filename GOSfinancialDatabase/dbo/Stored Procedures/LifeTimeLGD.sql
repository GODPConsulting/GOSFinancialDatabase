...
@Inflation7 as Inflation7,@erosion7 as erosion7,@ForegnEx7 as ForegnEx7,@Others7 as Others7,@otherfactor7 as otherfactor7
 ...
 from ifrs_var_coeff_comp_lgd

 insert into @tab(year, lgd1,lgd2,lgd3,lgd4,lgd5,lgd6,lgd7,lifetimelgd,lgdtype,LoanReferenceNumber,productCode)
...
case when c.LGD < b.Significant2 then
'12 Months ECL'
else
'Life Time ECL ' end as lgdtype,
a.LoanReferenceNumber,a.productCode
 from @tab1 a left outer join credit_product b on a.productCode = b.ProductCode left outer join credit_customerloanlgd_history_final c on a.LoanReferenceNumber = c.LoanReferenceNumber


 --select * from @tab
 --select @runyear
 update a set lifetimelgd = case 
 ...
 from @tab a left outer join credit_individualapplicationscorecard_history b on a.LoanReferenceNumber = b.LoanReferenceNumber
  delete from ifrs_forecasted_lgd where RunDate = @RunDate
 insert into ifrs_forecasted_lgd(Year, LGD1, LGD2, LGD3, LGD4, LGD5, LGD6, LGD7, LifeTimeLGD, LGDType, ApplicableLGD, ProductCode, LoanReferenceNumber, RunDate, Active, Deleted)
 select Year, LGD1, LGD2, LGD3, LGD4, LGD5, LGD6, LGD7, LifeTimeLGD, LGDType, ApplicableLGD, ProductCode, LoanReferenceNumber,@RunDate,1,0 from @tab
 where year >= @runyear
