...
CREATE proc [dbo].[spp_CalculateIndividualCustomerLoanPD_History_Test2]--9,12
...
from information_schema.columns
where table_name = 'credit_individualapplicationscorecard_history' and ordinal_position > @default and ordinal_position <= @productAttributeCount + @default
...
FROM
   ...
   ,cast(@productAttributeCount as int)
   )
   end
   select * from @tab2
begin
...
WHILE @rnct4 <= @rtmax4
	begin
			...
			,Field21,Field22,Field23,Field24,Field25,Field26,Field27,Field28,Field29,Field30,MaturityDate, LoanReferenceNumber)
			select Field1, Field2, Field3, Field4, Field5, Field6, Field7, Field8, Field9, Field10, Field11, Field12, Field13, Field14, Field15, Field16, Field17, Field18, Field19,
			 Field20, Field21, Field22, Field23, Field24, Field25, Field26, Field27, Field28, Field29, Field30, MaturityDate,@LoanReferenceNumber from credit_individualapplicationscorecard_history  where LoanReferenceNumber =@LoanReferenceNumber

			 truncate table #Tab3
			 insert into #Tab3(FieldName,Score,LoanReferenceNumber,MaturityDate)
			 SELECT FieldName,Score,LoanReferenceNumber,MaturityDate FROM #tab2
				UNPIVOT
					(
					Score
			   ...
			   AverageCoefficients, Year,Date,CustomerName,LoanReferenceNumber,ProductCode,ProductName)
			    ...
			    select isnull(b.FieldName, 'Intercepts'),b.FieldName,b.Score,a.stat_val as Coeff,(a.stat_val  *isnull(b.Score ,1))as pd ,
			    --@runyear  as Year,@RunDate as date , 
				(case when YEAR(b.MaturityDate) < @runyear then  
				YEAR(b.MaturityDate)
				else
			   @runyear end) as Year,
			   ...
			   (b.maturitydate) as date,
				...
				@CustomerName, @LoanReferenceNumber, @ProductCode,@ProductCode
				 from @tab3 a left outer join #Tab3 b on a.idx = b.id 
				 where b.LoanReferenceNumber = @LoanReferenceNumber
