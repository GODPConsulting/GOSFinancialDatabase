...
(@OutstandingAmount FLOAT (53), @InterestBasis NVARCHAR (4000), @InterestRate FLOAT (53), @PaymentFrequency INT, @MaturityDate DATETIME, @ReferenceDate DATETIME, @PrevPayDate DATETIME, @StartDate DATETIME, @FirstPayDate DATETIME, @GracePeriodStartDate DATETIME, @GracePeriodEndDate DATETIME)
RETURNS 
     TABLE (
        [Period]              INT        NULL,
