...
(@Settlement DATETIME, @Maturity DATETIME, @Steps NVARCHAR (MAX), @Yield FLOAT (53), @Redemption FLOAT (53), @Frequency FLOAT (53), @Basis NVARCHAR (4000), @Issue DATETIME, @FirstCoupon DATETIME, @LastCoupon DATETIME)
RETURNS 
     TABLE (
