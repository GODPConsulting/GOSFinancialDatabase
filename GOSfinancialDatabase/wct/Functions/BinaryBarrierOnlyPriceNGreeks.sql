CREATE FUNCTION [wct].[BinaryBarrierOnlyPriceNGreeks]
...
AS
 EXTERNAL NAME [XLeratorDB_suitePLUS2008].[XLeratorDB_suitePLUS2008.UserDefinedFunctions].[BinaryBarrierOnlyPriceNGreeks]
